...
public class Information extends JFrame implements ActionListener {
	...
	public Information(Login login, String number) {
		...
		backLabel = new JLabel(LoginUI.getImageIcon("2224.jpg", this.getWidth(), this.getHeight()));
	...
	public JComponent getPanel1() {
		...
		addbtn.setBounds(154, 93, 113, 27);
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 处理加为好友按钮事件
		else	if ("加为好友".equals(e.getActionCommand())) {
			try {
				login.getOut().writeUTF("addFriend_" + number);
				String str = login.getIn().readUTF();
				if (str.equals("true")) {
					...
					JOptionPane.showMessageDialog(this, "您已经添加该好友！");
				} else {
